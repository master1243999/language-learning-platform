        ...
        if (course.title === '英语入门') {
          if (topic.title.includes('字母与发音')) {
            exercisesData = [
              {
                ...
                answer: 'E',
                explanation: 'E is a vowel letter. Vowel letters include A, E, I, O, U.',
                topicId: topic.id
              },
              {
                type: 'fill_blank',
                ...
                answer: '26',
                explanation: 'There are 26 letters in the English alphabet, including 5 vowel letters and 21 consonant letters.',
                topicId: topic.id
              }
            ];
            ...
            exercisesData = [
              {
                type: 'single_choice',
                question: 'What should you say when meeting someone in the morning?',
                options: JSON.stringify(['Good night', 'Good morning', 'Good afternoon', 'Good evening']),
                answer: 'Good morning',
                explanation: 'You should say "Good morning" when meeting someone in the morning.',
                topicId: topic.id
              },
              {
                type: 'fill_blank',
                question: 'How do you say "你好，我是李明" in English?',
                answer: 'Hello, I am Li Ming.',
                explanation: 'To introduce yourself, you can say "Hello, I am [name]".',
                topicId: topic.id
              }
            ];
            ...
            exercisesData = [
              {
                ...
                answer: 'Fifteen',
                explanation: '"15" is said as "Fifteen" in English.',
                topicId: topic.id
              },
              {
                type: 'fill_blank',
                question: 'How do you say "现在是3点" in English?',
                answer: 'It is three o\'clock.',
                explanation: 'To express整点时间, you can say "It is [number] o\'clock".',
                topicId: topic.id
              }
            ];
            ...
            exercisesData = [
              ...
              {
                type: 'fill_blank',
                question: 'How do you say "你是老师吗？" in English?',
                answer: 'Are you a teacher?',
                explanation: 'The structure of a general question is: be verb + subject + other?',
                topicId: topic.id
              }
            ];
          }
          ...
          if (topic.title.includes('现在进行时')) {
            exercisesData = [
              {
                type: 'single_choice',
                question: 'Look! They ___ football.',
                options: JSON.stringify(['play', 'plays', 'are playing', 'is playing']),
                answer: 'are playing',
                explanation: 'The present continuous tense structure is: be verb + verb-ing. Since the subject is "they", we use "are playing".',
                topicId: topic.id
              },
              {
                type: 'fill_blank',
                question: 'How do you say "我正在读书" in English?',
                answer: 'I am reading a book.',
                explanation: 'The present continuous tense is used to express actions happening now. The structure is: be verb + verb-ing.',
                topicId: topic.id
              }
            ];
            ...
            exercisesData = [
              {
                ...
                answer: 'went',
                explanation: '"Yesterday" indicates past time, so we use the past tense. The past tense of "go" is "went".',
                topicId: topic.id
              },
              {
                type: 'fill_blank',
                question: 'How do you say "他昨天看了电影" in English?',
                answer: 'He watched a movie yesterday.',
                explanation: 'The past tense is used to express actions that happened in the past. The past tense of "watch" is "watched".',
                topicId: topic.id
              }
            ];
        ...
        if (course.title === '英语入门') {
          if (topic.title.includes('字母与发音')) {
            flashcardsData = [
              {
                front: 'A',
                back: 'Vowel letter, pronounced /eɪ/',
                order: 1,
                topicId: topic.id
              },
              {
                front: 'B',
                back: 'Consonant letter, pronounced /biː/',
                order: 2,
                topicId: topic.id
              },
              {
                front: 'C',
                back: 'Consonant letter, pronounced /siː/',
                order: 3,
                topicId: topic.id
              },
              {
                front: 'D',
                back: 'Consonant letter, pronounced /diː/',
                order: 4,
                topicId: topic.id
              }
            ];
            ...
            flashcardsData = [
              ...
              {
                front: 'Good morning',
                back: 'Greeting used in the morning',
                order: 2,
                topicId: topic.id
              },
              {
                front: 'How are you?',
                back: 'Asking about someone\'s well-being',
                order: 3,
                topicId: topic.id
              },
              {
            ...
            flashcardsData = [
              ...
              {
                front: 'is',
                back: 'Used with "he", "she", "it"',
                order: 2,
                topicId: topic.id
              },
              {
                front: 'are',
                back: 'Used with "you", "we", "they"',
                order: 3,
                topicId: topic.id
              },
              {
                front: 'What',
                back: 'Question word for asking about things',
                order: 4,
                topicId: topic.id
              }
            ];
